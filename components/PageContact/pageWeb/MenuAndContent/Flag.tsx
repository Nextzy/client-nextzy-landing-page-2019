...
const Flag = (props): React.FC => {
  ...
  return (
    <ContainerMap {...props}>
      <svg viewBox="0 0 288 150" width={getScreenContext}>
        <g transform={"translate(160,65)"}>
          <rect className="btn" width="50" height="50" onClick={() => setModal({ visible: true, map: map, isShowMap: true })} />
        </g>
        <g transform={"translate(175,80) scale(0.4 0.4)"} className="flag">
        ...
        <g fill="url(#prefix__asset_planent_halo_1-a)" fillOpacity=".1" fillRule="evenodd">
          <circle cx="183" cy="88" r="15" className="cls-10" onClick={() => setModal({ visible: true, map: map, isShowMap: true })} />
          <circle cx="183" cy="88" r="12" className="cls-9" onClick={() => setModal({ visible: true, map: map, isShowMap: true })} />
          <circle cx="183" cy="88" r="11" className="cls-10" onClick={() => setModal({ visible: true, map: map, isShowMap: true })} />
        </g>
        <g>
          <text>
            <tspan className="textSVG" x="170" y="107" onClick={() => setModal({ visible: true, map: map, isShowMap: true })}>
              Nextzy Technologies
              </tspan>
          </text>
        </g>
