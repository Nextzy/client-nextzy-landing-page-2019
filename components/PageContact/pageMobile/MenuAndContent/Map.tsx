      ...
      <ContainerMap {...props} useMapOut={useMapOut} map={map}>
        <svg viewBox="0 0 84 85.2">
          ...
          <g transform={'translate(23,40) scale(0.3 0.3)'} className="flag">
            ...
            <path
              className="flag-3"
              d="M10.78,19.21c1.,55-.75,4.91-2.65,7.07-2.35s2.21,3.58,4.73,3.55,4.47-2,7.92-2c2.12.05,2.09-.9,2.09-1.71l0-8.93c0-2.36-.08-2.85-2.1-2.85-3.46,0-5.41,2-7.92,2S20,3.68,17.85,3.37,12.33,5,10.78,5.72Z"
            />
            <path
              className="flag-4"
